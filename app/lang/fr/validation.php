...
return array(
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Messages renvoyés pour les validateurs "fait maisons", qu'on peut retrouver
    | dans app/Lib/Validation/Validation.php sous forme de méthodes spécifiques.
    |
    */
    "alnum_spaces"      => "Le champ :attribute ne peut contenir que des lettres, des chiffres, des espaces et un tiret.",
    "positive_int"      => "Le champ :attribute doit être un nombre entier positif.",
    "telephone_fr"      => 'Le numéro de téléphone ne peut contenir que des chiffres, des - ou des espaces.'
