...
{{ Form::model($recette, array('class' => 'form-horizontal', 'method' => 'PATCH', 'route' => array('recettes.update', $recette->id))) }}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
      ...
      {{ link_to_route('recettes.show', 'Cancel', $recette->id, array('class' => 'btn btn-lg btn-default')) }}
    </div>
</div>
